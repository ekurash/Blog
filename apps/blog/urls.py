...
from apps.blog.views import ListPostView, CreatePostView, UpdatePostView, \
    DeletePostView, DetailPostView
from apps.blog.views import ListTagView, CreateTagView, UpdateTagView, \
    DeleteTagView, DetailTagView
from apps.blog.views import SimpleTemplate
...
urlpatterns = [
    ...
    path(r'simple', SimpleTemplate.as_view(), name='such_a_simple'),
    path(r'contact/', CreatePostView.as_view(), name='contact-info'),
]
